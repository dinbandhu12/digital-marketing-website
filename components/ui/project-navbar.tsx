...
const ProjectNavbar = () => {
  return (
    <div className="overflow-hidden rounded-[6px] top-5 sticky md:mx-auto z-50 lg:w-4/5 2xl:w-[68%] bg-gray-200 flex items-center justify-between px-4 md:px-8 mx-6">
      <Link href="/">
        <Image
          src={"/logo/logo.svg"}
          alt="Logo"
      ...
      <div className="absolute right-1/2 translate-x-1/2 transform">
          ...
          <Link href={"/"} className="hover:text-[#2F2121]">
            Services
          </Link>
          <Link href={"/"} className="hover:text-[#2F2121]">
            Process
